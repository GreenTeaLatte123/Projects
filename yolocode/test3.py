...
while cap.isOpened():
    ...
    if success:
        ...
        for r in results:
            print(r.boxes.cls)
            if 12 in r.boxes.cls and frame_counter % 50 == 0:
                ...
                # Firebase Realtime Database에 "class detection" 텍스트 업로드
                db_ref.child('class_detection').push('class detection')
